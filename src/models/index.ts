...
import {DEFAULT_VOYAGER_CHART_CONFIG, VoyagerChartConfig} from './chartConfig';
...
export const DEFAULT_PERSISTENT_STATE: PersistentState = {
  ...
  chartConfig: DEFAULT_VOYAGER_CHART_CONFIG,
  log: DEFAULT_LOG,
...
export function fromSerializable(serializable: SerializableState): Readonly<State> {
  ...
  const persistent: PersistentState = {bookmark, config, chartConfig, relatedViews, shelfPreview, log};
